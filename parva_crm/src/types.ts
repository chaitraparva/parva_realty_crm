...
export type LeadStatus =
  ...
  | 'Cancelled'
export type ActivityType = 'call' | 'email' | 'note' | 'site-visit' | 'whatsapp' | 'transfer' | 'escalation' | 'ai-assignment'
...
// Formal lead-approval workflow (CRM Executive → Sales Manager → Super
// Admin), backed by the real `approvals` table via /api/approvals.
...
export interface Notification {
  id: string
  type: 'missed-followup' | 'unassigned-lead' | 'pending-payroll' | 'leave-request' | 'flag' | 'lead-cancelled' | 'site-visit' | 'lead-transfer' | 'escalation' | 'ai-assignment' | 'approval'
  title: string
  message: string
  timestamp: string
  read: boolean
